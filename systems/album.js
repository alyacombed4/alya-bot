...
// COMANDO: !abrirpacote
// ═══════════════════════════════════════════════════════════════════════════════
async function cmdAbrirPacote(message) {
...
// ═══════════════════════════════════════════════════════════════════════════════
// COMANDO: !figurinha <id>
// ═══════════════════════════════════════════════════════════════════════════════
async function cmdFigurinha(message, args) {
  if (!checkCanal(message)) return;
  ...
  try {
    const imgBuffer = gerarImagemFigurinha(fig);
    const attachment = new AttachmentBuilder(imgBuffer, { name: `figurinha_${id}.png` });
    ...
    await msg.edit({ embeds: [embed('❌ Erro', 'Erro ao gerar imagem da figurinha.')] });
  }
}

// ═══════════════════════════════════════════════════════════════════════════════
// COMANDO: !colecao [pagina]
// ═══════════════════════════════════════════════════════════════════════════════
async function cmdColecao(message, args) {
  if (!checkCanal(message)) return;
  ...
  try {
    ...
    const resumo = Object.entries(porRaridade)
      .map(([r, n]) => `${RARIDADE_EMOJI[r]} ${n}`)
      .join(' • ');
    ...
    console.error('Erro colecao:', err);
    await msg.edit({ embeds: [embed('❌ Erro', 'Erro ao gerar a coleção.')] });
  }
}
...
// COMANDO: !album
// ═══════════════════════════════════════════════════════════════════════════════
async function cmdAlbum(message) {
  if (!checkCanal(message)) return;
...
// ═══════════════════════════════════════════════════════════════════════════════
// COMANDO: !trocar @usuario <id_oferta> <id_pedido>
// ═══════════════════════════════════════════════════════════════════════════════
async function cmdTrocar(message, args) {
  if (!checkCanal(message)) return;
  ...
  message.reply({ content: `${receptor}`, embeds: [e] });
}

// ═══════════════════════════════════════════════════════════════════════════════
// COMANDOS: !aceitartroca / !recusartroca
// ═══════════════════════════════════════════════════════════════════════════════
async function cmdAceitarTroca(message, args) {
  if (!checkCanal(message)) return;
...
// ═══════════════════════════════════════════════════════════════════════════════
// COMANDO: !darfigurinha @usuario <id>
// ═══════════════════════════════════════════════════════════════════════════════
async function cmdDarFigurinha(message, args) {
  if (!checkCanal(message)) return;
...
// ═══════════════════════════════════════════════════════════════════════════════
// COMANDO: !venderfigurinha <id> [quantidade]
// ═══════════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════════
// COMANDO: !comprarpacote [quantidade]
// ═══════════════════════════════════════════════════════════════════════════════
    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          '`!figurinha <id>` — Ver uma figurinha específica',
